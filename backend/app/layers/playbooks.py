...
PLAYBOOKS: dict[str, Playbook] = {
    ...
    "breakout_hunter": Playbook(
        ...
        strength="Volatilite patlamasının başında konumlanır; hızlı ve büyük kazanç.",
    ...
    "range_harvester": Playbook(
        ...
        strength="Trend olmayan dönemlerde — yılın yarısı — para kazandırır.",
    ...
    "volatility_breakout": Playbook(
        ...
        strength="Haber/olay kaynaklı sert hareketlerde çok hızlı R üretir.",
